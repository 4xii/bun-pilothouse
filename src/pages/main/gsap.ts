...
// 场景1的动画
export function createScene1Animation() {
...
// 场景2的动画
export function createScene2Animation() {
  /*   SCENE 2  */
...
// 蝙蝠动画
export function createBatsAnimation() {
...
// 太阳增强动画
export function createSunIncreaseAnimation() {
  /* Sun increase */
...
// 场景3动画
export function createScene3Animation() {
...
// 流星动画
export function createFallingStarAnimation() {
...
export const dayNightSwitch = (isDay:boolean) =>{
  gsap.to(window, {
    scrollTo: isDay ? 0 : document.body.scrollHeight,
    duration: 1
  });
}
