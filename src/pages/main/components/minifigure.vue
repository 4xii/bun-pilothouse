    ...
    <div :class="['minifigure', { explode: isExploded }]">
      <div class="head">
        <div class="faces-wrap">
          <div class="faces" :style="{ transform: `translateX(-${expressionVal}%)` }">
...
export default {
  setup() {
    ...
    const explodeText = ref("Explode");
    const expressionVal = ref(0);
    ...
    function explodeMinifigure() {
      ...
      explodeText.value = isExploded.value ? 'Rebuild' : 'Explode';
    }

    function randomizeInputs() {
      expressionVal.value = getRandomNum(0, 5) * 100;
      upperHue.value = getRandomNum(0, 360);
      upperSaturation.value = getRandomNum(0, 100);
      upperLightness.value = getRandomNum(0, 90);
      lowerHue.value = getRandomNum(0, 360);
      lowerSaturation.value = getRandomNum(0, 100);
      lowerLightness.value = getRandomNum(0, 90);
    }
